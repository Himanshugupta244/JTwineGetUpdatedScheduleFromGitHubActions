...
public class ScheduleJtwineFinalCodeSud {
    
    private static WebDriver driver;
    private static WebDriverWait wait;
    private static final String EMAIL = System.getenv("JTWINE_EMAIL_SUD");
    private static final String PASSWORD = System.getenv("JTWINE_PASSWORD_SUD");
    ...
    private static void insertCandidateLog(String candidateName, String triedForTime, String primaryMsg, String secondaryMsg, int attemptCounter) {
        ...
        try {
            DB_EXECUTOR.submit(() -> {
                try {
                    String sql = "INSERT INTO candidatelogssud (candidate_name, tried_for_time, primary_message, secondary_message, attempt_counter) VALUES (?, ?, ?, ?, ?)";
